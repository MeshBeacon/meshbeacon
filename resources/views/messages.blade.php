...
<el-select id="table-select" name="selected" value="20" class="block">
  ...
  <el-options anchor="bottom start" popover class="m-0 max-h-60 w-[var(--button-width)] overflow-auto rounded-md bg-white dark:bg-gray-800 p-0 py-1 text-base outline outline-1 -outline-offset-1 outline-gray-200 dark:outline-white/10 [--anchor-gap:theme(spacing.1)] data-[closed]:data-[leave]:opacity-0 data-[leave]:transition data-[leave]:duration-100 data-[leave]:ease-in data-[leave]:[transition-behavior:allow-discrete] sm:text-sm">
    ...
    <el-option value="10" class="group/option relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900 dark:text-white focus:bg-orange-500 focus:text-gray-900 focus:outline-none [&:not([hidden])]:block">
      <span class="block truncate font-normal group-aria-selected/option:font-semibold">{{ __('20 rows') }}</span>
      <span class="absolute inset-y-0 right-0 flex items-center pr-4 text-orange-600 dark:text-orange-400 group-focus/option:text-gray-900 group-[:not([aria-selected='true'])]/option:hidden [el-selectedcontent_&]:hidden">
        <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="size-5">
          <path d="M16.704 4.153a.75.75 0 0 1 .143 1.052l-8 10.5a.75.75 0 0 1-1.127.075l-4.5-4.5a.75.75 0 0 1 1.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 0 1 1.05-.143Z" clip-rule="evenodd" fill-rule="evenodd" />
        </svg>
      </span>
    </el-option>
    <el-option value="50" class="group/option relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900 dark:text-white focus:bg-orange-500 focus:text-gray-900 focus:outline-none [&:not([hidden])]:block">
    ...
    <el-option value="100" class="group/option relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900 dark:text-white focus:bg-orange-500 focus:text-gray-900 focus:outline-none [&:not([hidden])]:block">
    ...
    <el-option value="200" class="group/option relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900 dark:text-white focus:bg-orange-500 focus:text-gray-900 focus:outline-none [&:not([hidden])]:block">
    ...
    <el-option value="500" class="group/option relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900 dark:text-white focus:bg-orange-500 focus:text-gray-900 focus:outline-none [&:not([hidden])]:block">
    ...
    <el-option value="1000" class="group/option relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900 dark:text-white focus:bg-orange-500 focus:text-gray-900 focus:outline-none [&:not([hidden])]:block">
    ...
    <div class="relative mt-3 mb-3">
      ...
      <input id="custom-filter" type="text" name="search" class="rounded-md min-w-0 grow bg-gray-100 dark:bg-white/5 pl-9 pr-3 py-1.5 text-base text-gray-900 dark:text-white placeholder:text-gray-500 outline outline-1 -outline-offset-1 outline-gray-200 dark:outline-white/10 focus:outline-2 focus:-outline-offset-2 focus:outline-orange-500 sm:text-sm/6" />
    </div>
  </div>
