...
<div class="p-6">
    ...
    <div class="mt-8 bg-white dark:bg-gray-800/50 rounded-lg p-6 ring-1 ring-gray-200 dark:ring-white/10">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="https://github.com/muhammadn" target="_blank" class="inline-flex items-center gap-2 rounded-full bg-gray-50 dark:bg-gray-900 px-4 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-yellow-400 hover:ring-yellow-500/50 ring-1 ring-inset ring-gray-200 dark:ring-white/10 transition-colors">
                Muhammad Nuzaihan Bin Kamal Luddin
            </a>
            <a href="https://hamradio.my" target="_blank" class="inline-flex items-center gap-2 rounded-full bg-gray-50 dark:bg-gray-900 px-4 py-1.5 text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-yellow-400 hover:ring-yellow-500/50 ring-1 ring-inset ring-gray-200 dark:ring-white/10 transition-colors">
                9M2PJU
            </a>
        </div>
    </div>
