...
<div class="flow-root w-140 bg-transparent border border-white/10 m-4 rounded-base shadow-xs p-6 overflow-hidden">
  <ul role="list" class="-mb-8">
        ...
        {{-- Incident Response SLA (last 7 days) --}}
        <div class="mt-4">
          <h2 class="text-sm font-semibold uppercase tracking-wide text-white mb-3">Incident Response (7 days)</h2>
          <dl class="grid grid-cols-1 gap-5 sm:grid-cols-3" id="sla-stats">
            <div class="overflow-hidden rounded-lg bg-gray-800/75 px-4 py-5 shadow ring-1 ring-inset ring-white/10 sm:p-6">
        ...
        <div id="incidents" class="mt-6 mb-2">
          ...
          <div class="relative mb-3 max-w-sm">
            ...
            <input id="incidents-search" type="text" placeholder="Search duck, notes, assignee…"
