    ...
    <div class="mt-6">
        <form wire:submit="uploadMap" class="space-y-6 max-w-xl">
            ...
            <flux:field>
                ...
                <div class="mt-2 flex justify-center rounded-lg border border-dashed border-white/25 px-6 py-10">
                    <div class="text-center">
                        ...
                        <div class="mt-4 flex text-sm leading-6 text-gray-400 justify-center">
                            <label for="file-upload" class="relative cursor-pointer rounded-md bg-gray-900 font-semibold text-yellow-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-yellow-500 focus-within:ring-offset-2 focus-within:ring-offset-gray-900 hover:text-yellow-400">
                                <span>{{ __('Upload a file') }}</span>
                                <input id="file-upload" wire:model="mapFile" type="file" accept=".mbtiles" class="sr-only">
                            </label>
                            <p class="pl-1">{{ __('or drag and drop') }}</p>
                        </div>
                        <p class="text-xs leading-5 text-gray-500">{{ __('MBTiles up to 500MB') }}</p>
                    </div>
                </div>
                ...
                @endif
                <flux:error name="mapFile" class="mt-2 text-red-400" />
            </flux:field>
            ...
            <div wire:loading wire:target="uploadMap" class="mt-2">
                <span class="text-sm text-gray-400 flex justify-end items-center gap-2">
                    <svg class="animate-spin h-4 w-4 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
            ...
            <div class="mt-6 rounded-md bg-blue-500/10 p-4 ring-1 ring-inset ring-blue-500/30">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-blue-400">{{ __('Current Map Status') }}</p>
